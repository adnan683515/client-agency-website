...
export default function Navbar() {
    ...
    const { aboutRef, serviceRef, contactRef, goToProjectSection } = useMyContext();

    const navLinks = [
        { label: 'Home', ref: serviceRef },
    ...
    return (
        ...
        >
            <div className="max-w-[90%] mx-auto flex items-center justify-between py-4 sm:px-6 lg:px-0">
                <Link href="/">
